...
* Fix - Dates were removed in order page when in the past.

= 3.3.3 - 2024-08-29 =

* Fix - Unable to modify booking status from pending to start when set to Manually.
* Fix - Unable to modify booking dates in order if new start date was later than old end date.
* Fix - Datepickers minimum date wasn't set in admin order page.
* Tweak - Removed legacy booking metadata.

= 3.3.2 - 2024-06-27 =

* Compatibility with Easy Booking PRO 1.1.7.
* Fix - Conflict with WooCommerce Product Add-Ons new date field.
* Fix - Remove deprecated WooCommerce Rest API compatibility.
